if game.PlaceId == 286090429 then
    ...
    local Window = Library.CreateLib("SHARK X HUB l Blox fruit", "GrapeTheme")
	

    -- MAIN
    local Main = Window:NewTab("Main")
    Main:NewButton("ESP Players", "ESP Players", function()
...
elseif game.PlaceId == 3956818381 then
	...
	TeleportSection:NewButton("Teleport #1 Island", "Teleport #1 Island", function()
	...
	TeleportSection:NewButton("Teleport #2 Island", "Teleport #2 Island", function()
